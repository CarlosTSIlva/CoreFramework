...
public class CustomButton: UIButton {
    ...
    public init(title: String, width: CGFloat, backgroundColors: UIColor = Colors.primaryRedBase) {
        super.init(frame: .zero)
        setupButton(title: title, icon: nil, iconPosition: nil, backgroundColor: backgroundColors)
    }
